    ...
    <section className="w-full flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2 p-4 md:p-0">
        <div className="flex-items-start">
          <p className="profile-detail-label-2">Company Legal Name:</p>
          <p className="profile-detail">{data.companyLegalName}</p>
        </div>

        <div className="flex-items-start">
          <p className="profile-detail-label-2">Trading as (if Different):</p>
          <p className="profile-detail">{data.tradingAs}</p>
        </div>
        <div className="flex-items-start">
          <p className="profile-detail-label-2">Company Registration No:</p>
          <p className="profile-detail">{data.companyRegistrationNo}</p>
        </div>
        <div className="flex-items-start">
          <p className="profile-detail-label-2">VAT No:</p>
        ...
        <div className="flex-items-start">
          <p className="profile-detail-label-2">Street:</p>
          <p className="profile-detail">
            {data.registeredBusinessAddress.street}
          </p>
        </div>
        <div className="flex-items-start">
          <p className="profile-detail-label-2">City:</p>
          <p className="profile-detail">
            {data.registeredBusinessAddress.city}
          </p>
        </div>
        <div className="flex-items-start">
          <p className="profile-detail-label-2">Country:</p>
          <p className="profile-detail">
            {data.registeredBusinessAddress.country}
          </p>
        </div>
        <div className="flex-items-start">
          <p className="profile-detail-label-2">Post Code:</p>
          <p className="profile-detail">
            {data.registeredBusinessAddress.postCode}
          </p>
        </div>
        <div className="flex-items-start">
          <p className="profile-detail-label-2">Company Website:</p>
          <p className="profile-detail">
            {data.companyWebsite ? data.companyWebsite : "N/A"}
          </p>
        </div>
        <div className="flex-items-start">
          <p className="profile-detail-label-2">Industry / Sector:</p>
