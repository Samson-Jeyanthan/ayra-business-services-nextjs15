...
const ClientChoose = () => {
  return (
    <section className="flex flex-col min-h-screen p-20 gap-10 bg-light-600">
      <h1 className="heading-2">why our clients choose us?</h1>
      <p className="font-medium text-light-400 w-1/2">
      ...
      <div className="flex gap-8 w-full">
        {WHY_CHOOSE.map((item) => (
          <div
            key={item.name}
            className="flex flex-col w-1/4 gap-6 rounded-3xl bg-light-800 text-light-100 p-8"
          >
